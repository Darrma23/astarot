		...
		export async function participantsUpdate({ id, participants, action }) {
		    ...
		    for (const p of participants) {
		        ...
		        if (action === "add") {
		            ...
		            body = `+ Total members: ${meta.participants.length}`;
		        }
		        ...
		        // ===================
		            ...
		            body = `- Members remaining: ${meta.participants.length}`;
		        }
		        ...
		        // ===================
		            ...
		            title = "[ SYSTEM NOTICE ] Admin Promote";
		        ...
		        // ===================
		            ...
		            title = "[ SYSTEM NOTICE ] Admin Demote";
		            body = `Admin Removed: ${username}`;
		        }
		
		        // kalau unknown action, skip saja
		        else continue;
